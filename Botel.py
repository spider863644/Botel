...
bot = Bot("2099139630:AAFKNa5o1viZ4cT_OWf0vU9MPThBpMet4XE")

updater=Updater("2099139630:AAFKNa5o1viZ4cT_OWf0vU9MPThBpMet4XE", use_context=True)
import time as t
import os
os.system("clear")
"""
...
t.sleep(1)
print("""BOTEL:I have some hacking tools which might be useful to you
This are the Hacking tools
...
""")
    ...
    print("""
    Redirecting to  https://cryptotabbrowser.com/27178853...
    """)
    t.sleep(4)
    os.system("xdg-open https://cryptotabbrowser.com/27178853")
elif c == "10":
    os.system("""cd $HOME
    rm -f -r Botel
